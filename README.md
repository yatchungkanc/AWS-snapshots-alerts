...
Below is a sample of the snapshot inventory report generated by the application. The output shows a comprehensive summary of snapshots across different AWS services, including their age distribution and storage consumption:

![Sample Snapshot Inventory Report](sample-output.png)
